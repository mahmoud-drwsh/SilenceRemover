...
TARGET_MIN_DURATION_END_SEC = 0.01
TARGET_MIN_DURATION_STEP_SEC = 0.01
TARGET_MIN_DURATION_TIERS = [
    0.5 - i * 0.01 for i in range(50)
]  # [0.5, 0.49, 0.48, ..., 0.01]
...
__all__ = [
    ...
    "TARGET_MIN_DURATION_START_SEC",
    "TARGET_MIN_DURATION_END_SEC",
    "TARGET_MIN_DURATION_STEP_SEC",
    "TARGET_MIN_DURATION_TIERS",
