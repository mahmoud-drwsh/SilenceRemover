...
- **Upload eligibility**: With Media Manager configured, client upload is portrait-only. A recording must probe as `height > width`; horizontal, square, or unprobeable files are skipped before any server upload.
