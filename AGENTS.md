...
- **Subtitle delivery**: Linked video cards expose the embedded subtitle track through the MP4 downloads and also provide a separate SRT download when the deterministic `{source-id}-subtitles` asset exists.
