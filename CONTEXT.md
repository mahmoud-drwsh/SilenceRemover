...
- **Subtitle SRT**: A pipeline-generated SubRip text file. Gemini supplies only one verbatim text per retained speech segment; the pipeline derives all cue timings from the trim plan.
